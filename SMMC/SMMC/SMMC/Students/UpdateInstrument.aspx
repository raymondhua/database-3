<%@ Page Title="Update instrument from student" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateInstrument.aspx.cs" Inherits="SMMC.Students.UpdateInstrument" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <fieldset>
        ...
        <p><asp:Label ID="HireLabel" runat="server" Text="Hire: "></asp:Label>
